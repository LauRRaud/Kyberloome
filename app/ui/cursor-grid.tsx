...
// Adapted from React Bits Cursor Grid by David Haz.
// License: ./cursor-grid.LICENSE.md; source: https://reactbits.dev/animations/cursor-grid
...
const CursorGrid = ({
  ...
  return (
    <div ref={containerRef} aria-hidden="true" className={`cursor-grid${className ? ` ${className}` : ''}`}>
