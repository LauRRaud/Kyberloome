...
const services = [
  ['Veebilahendused', 'Kaasaegsed kodulehed, maandumislehed, kliendiportaalid ja veebirakendused.', 'DIGITAALNE KOHALOLEK'],
  ['Tarkvaraarendus', 'Ettevõtte vajadustele loodud süsteemid, halduskeskkonnad ja digitaalsed töövahendid.', 'SINU ETTEVÕTTELE LOODUD'],
  ['SaaS-lahendused', 'Veebipõhised tarkvaratooted, mida saab kasutada kuutasu või tellimuse alusel.', 'IDEEST OMA TOOTENI'],
  ['Automatiseerimine & AI', 'Korduvate tööprotsesside automatiseerimine ning tehisintellekti praktiline kasutamine.', 'ROHKEM AEGA OLULISELE'],
];
const steps = [
...
export default function Home() {
  return <>
    ...
    <main id="sisu">
      ...
      <section id="tooted" className="section wrap"><div className="section-heading"><div><p className="eyebrow">02 / MEIE TOOTED</p><h2>Loome ka oma<br/><span className="muted">digitooteid.</span></h2></div><p>Ideed, mille oleme ise ette võtnud.<br/>Lahendused, mille arengusse usume.</p></div><div className="products"><article className="product"><div className="product-body"><div className="product-title"><h3>broneering.info</h3><span className="badge">Arendamisel</span></div><p>Paindlik broneerimissüsteem teenusepakkujatele. Teenused, töötajad, kalender ja kliendi broneerimine — ettevõtte enda kujundusega.</p><a className="product-link" href="https://broneering.info" target="_blank" rel="noopener noreferrer">Vaata broneering.info <Arrow/></a></div></article><article className="product"><div className="product-body"><div className="product-title"><h3>sotsiaal.ai</h3><span className="micro">DIGITAALNE PLATVORM</span></div><p>Sotsiaalvaldkonna digitaalne platvorm, mis aitab infot, teenuseid ja võimalusi paremini kättesaadavaks teha.</p><a className="product-link" href="https://sotsiaal.ai" target="_blank" rel="noopener noreferrer">Vaata sotsiaal.ai <Arrow/></a></div></article></div></section>
