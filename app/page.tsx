  ...
  return <>
    ...
    <main id="sisu">
      <section className="hero wrap">
        <div className="hero-sculpture" aria-hidden="true"><svg viewBox="-30 -30 540 580" fill="none"><defs><linearGradient id="thread-light" x1="40" y1="40" x2="420" y2="460" gradientUnits="userSpaceOnUse"><stop stopColor="#fff" stopOpacity="0"/><stop offset=".18" stopColor="#fff" stopOpacity=".15"/><stop offset=".46" stopColor="#eee" stopOpacity=".65"/><stop offset=".82" stopColor="#fff" stopOpacity=".15"/><stop offset="1" stopColor="#fff" stopOpacity="0"/></linearGradient><linearGradient id="thread-fade" x1="0" y1="65" x2="0" y2="455" gradientUnits="userSpaceOnUse"><stop stopColor="black"/><stop offset=".15" stopColor="white"/><stop offset=".85" stopColor="white"/><stop offset="1" stopColor="black"/></linearGradient><mask id="thread-ends"><rect x="-30" y="-30" width="540" height="580" fill="url(#thread-fade)"/></mask></defs><g mask="url(#thread-ends)" stroke="url(#thread-light)" strokeWidth=".8">{Array.from({length:24},(_,i)=><path key={i} d={`M ${75+i*5} 65 C ${430-i*4} ${75+i*5}, ${40+i*4} ${400-i*5}, ${405-i*5} 455`}/>)}</g></svg></div>
